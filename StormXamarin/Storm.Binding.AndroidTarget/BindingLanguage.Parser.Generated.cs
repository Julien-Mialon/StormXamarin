...
// UserName: Julian
// Input file <C:\Users\Julian\Source\Repos\StormXamarin\StormXamarin\Storm.Binding.AndroidTarget\BindingLanguage.Language.grammar.y - 26/02/2015 13:41:50>
...
#pragma warning restore 649
  ...
  private static string[] nonTerms = new string[] {
      "expression", "$accept", "expressionKeyword", "expressionContent", "dualContent", 
      "values", };
  ...
  static BindingLanguageParser() {
    ...
    states[3] = new State(new int[]{8,18,9,19,10,20},new int[]{-3,4});
    states[4] = new State(new int[]{11,7,5,-6},new int[]{-4,5,-5,17});
    states[5] = new State(new int[]{5,6});
    states[6] = new State(-2);
    states[7] = new State(new int[]{6,8,7,11,5,-7});
    states[8] = new State(new int[]{11,10},new int[]{-5,9});
    states[9] = new State(-8);
    states[10] = new State(new int[]{7,11});
    states[11] = new State(new int[]{11,15,4,3},new int[]{-6,12,-1,16});
    states[12] = new State(new int[]{6,13,5,-10});
    states[13] = new State(new int[]{11,10},new int[]{-5,14});
    ...
    rules[7] = new Rule(-4, new int[]{11});
    rules[8] = new Rule(-4, new int[]{11,6,-5});
    rules[9] = new Rule(-4, new int[]{-5});
    rules[10] = new Rule(-5, new int[]{11,7,-6});
    rules[11] = new Rule(-5, new int[]{11,7,-6,6,-5});
