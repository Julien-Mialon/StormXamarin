...
namespace TestApp.Android.Activities
{
	...
	public partial class MainActivity
	{
		...
		protected override List<BindingObject> GetBindingPaths()
		{
			...
			o1.AddExpression(e2);
			BindingObject o2 = new BindingObject(this.MyTextView);
			result.Add(o2);
			BindingExpression e3 = new BindingExpression("text", "InputText");
			o2.AddExpression(e3);
			BindingObject o3 = new BindingObject(this.TTextView);
			result.Add(o3);
			BindingExpression e4 = new BindingExpression("text", "Data.Text");
			o3.AddExpression(e4);
			BindingObject o4 = new BindingObject(this.TCTextView);
			result.Add(o4);
